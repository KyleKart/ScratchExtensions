(function (ext) {
    ...
    var blocks = [
        ...
        [' '],
        ['obj', 'get %s from %s', 'getKey', 'key', '{"key":"value"}'],
        ['obj', 'set %s to %s in %s', 'setKey', 'key', 'value', '{}'],
        ['obj', 'remove %s from %s', 'removeKey', 'key', '{"key":"value"}'],
        ['b', 'does %s exist in %s?', 'keyExists', 'key', '{"key":"value"}'],
        [' '],
        ['a', 'add %s to %s', 'addItem', 'item', '[]'],
        ['a', 'remove item %n of %s', 'removeItem', 0, '[]'],
        ['a', 'item %n of %s', 'getItem', 0, '[]'],
        ['a', 'insert %s at %n of %s', 'insertItem', 'item', 0, '[]'],
        ['a', 'item %s of %s', 'indexOfItem', 'item', '[]'],
        [' '],
    ];
